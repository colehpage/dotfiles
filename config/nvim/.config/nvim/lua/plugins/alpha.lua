...
function M.setup()
    ...
    section.buttons = {
        type = "group",
        val = {M.dashboard.button("⌘ N", "  Create file", "<Cmd>normal <C-n><CR>"),
    ...
    M.dashboard.config.layout = {section.padding(12), section.header, section.padding(2), section.project,
                                 section.padding(1), section.buttons, section.padding(1), section.footer}
