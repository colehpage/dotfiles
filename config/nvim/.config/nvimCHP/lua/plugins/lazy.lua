...
require('lazy').setup({'jackMort/ChatGPT.nvim', {
    ...
    keys = {{
        ...
        desc = "Show location list of backlinks",
        mode = "n"
    }, {
        "<leader>ot",
    ...
    dependencies = {"nvim-lua/plenary.nvim"}
}, 'folke/zen-mode.nvim', 'David-Kunz/gen.nvim', 'tpope/vim-dadbod', 'tpope/vim-obsession',
                       'kristijanhusak/vim-dadbod-ui', 'kristijanhusak/vim-dadbod-completion',
                       'lewis6991/impatient.nvim', -- whichkey
{
...
}, 'ThePrimeagen/git-worktree.nvim', 'tpope/vim-surround', 'xiyaowong/nvim-transparent', {
    'numToStr/FTerm.nvim',
    config = function()
...
'tpope/vim-fugitive', 'lewis6991/gitsigns.nvim', 'navarasu/onedark.nvim', -- Theme inspired by Atom
...
-- Fuzzy Finder (files, lsp, etc)
{
    ...
    branch = '0.1.x',
    dependencies = {'nvim-lua/plenary.nvim'}
}, 'nvim-telescope/telescope-symbols.nvim', -- 'ThePrimeagen/harpoon',
